...
Cette approche géométrique est ici représentée par trois modèles : TransE, TransH, TransD. 
...
\begin{equation}
    ...
    \end{cases}
\end{equation}
On peut en voir une illustration dans la figure \ref{fig:kge-algebric-overview}.
...
Pour une relation $r \in \Rel$, on note $\cal{X}_{r}$ la matrice d'adjacence associée à cette relation : $\cal{X}_{r_k}$ est une matrice booléenne carrée de dimension $n$.
