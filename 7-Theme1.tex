...
Il fonctionne en deux étapes. % : d'abord, des chemins sont prélevés dans le graphe de connaissances au moyen de marches aléatoires – ces chemins sont simplement des suites d'entités et de relations connectées entre elles. % Pour les prélever, on commence par tirer aléatoirement une entité 
