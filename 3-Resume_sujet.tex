...
%L'importance qu'ont pris les graphes de connaissance dans de nombreux domaines Le problème de l'extraction automatique de taxonomies 


% Les graphes de connaissance constituent le cœur du Web sémantique, et trouvent aujourd'hui des applications dans des domaines très variés;
