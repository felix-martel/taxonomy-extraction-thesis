...
utile pour explorer les classes, identifie des relations et notamment des relations manquantes (cf automobile par exemple, mais pas uniquement)

classes mal gérées : notamment les lieux habités

discussion : en l'état, plutôt un outil d'exploration de graphes de connaissance et d'aide à la création/mise à jour de taxonomie, + connaitre ces axiomes peut aider à guider l'extraction non supervisée de triplets rdf à partir de texte

en revanche, on ne peut pas encore s'affranchir de supervision humaine et l'utiliser comme un outil non supervisé de bout en bout (doublons, varabilité des classes, pas encore au standard humain).

future work : évaluer les axiomes extraits à l'aide de downstream tasks (lesquelles ?)
