...
Soit un axiome d'entrée $a$. Lors de la première étape, $a = \top$, c'est-à-dire que l'on considère toutes les entités du graphe, sans restrictions. Dans les étapes suivantes, d'autres axiomes seront utilisés.
