...
\newcommand\monTitre{Extraction de taxonomie par regroupement hiérarchique de plongements lexicaux}
...
\newcommand\monJury{\PresidentJury{F}{Nom}{Prénom}\\
\DirecteurRecherche{M}{Zouaq}{Amal}\\
%\CoDirecteurRecherche{F}{Couture}{Marie}\\
\MembreJury{M}{Gagnon}{Michel}\\
