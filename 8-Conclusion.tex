...
Une première extension du travail effectué ici consisterait à essayer d'autres graphes de connaissance : on pourrait expérimenter avec DBpedia dans d'autres langues que l'anglais, avec d'autres graphes généralistes comme YAGO \cite{suchanek2008yago} ou Wikidata \cite{vrandevcic2014wikidata}, ou avec des graphes spécialisés.
