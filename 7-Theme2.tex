...
La distance entre $A$ et $B$ est la distance minimale entre un point de $A$ et un point de $B$ :
\begin{equation}
...
Ici, la distance entre $A$ et $B$ est la distance moyenne entre leurs entités :
\begin{equation}
...
Cette fois, la distance entre $A$ et $B$ est la distance maximale entre un point de $A$ et un point de $B$ :
\begin{equation}
...
\begin{equation}
    I(C) = \sum_{\bf{x} \in C} d(\bf{x}, \frac{1}{|C|} \sum_{\bf{y} \in C} \bf{y})
\end{equation}
...
\begin{align}
    ...
    &= \sum_{\bf{x} \in A\cup B} d(\bf{x}, g(A \cup B) 
    - \sum_{\bf{x} \in A} d(\bf{x}, g(A) 
    - \sum_{\bf{x} \in B} d(\bf{x}, g(B) 
\end{align}
