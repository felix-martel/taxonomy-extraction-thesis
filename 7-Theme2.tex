...
% Le point de départ est un ensemble de données sans hiérarchie, constitué de plongements vectoriels typés
...
% TODO
% - écrire l'intro
% - trouver des noms français (Liaison multiple / Liaison injective)
