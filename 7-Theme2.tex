...
Pour évaluer les performances moyennes de chaque combinaison de paramètres, on calcule la mesure $F_1$ de chaque combinaison, moyennée sur l'ensemble des modèles de plongements, et ce, pour les deux modes d'extraction Hard Mapping et Soft Mapping, et pour les deux modes d'évaluation direct et transitve. Le résultat est tracé à la figure \ref{fig:taxex-cluparams-all}.
